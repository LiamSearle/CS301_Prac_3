...
public class Parser {
	...
	static void Operator() {
		if (la.kind == barbar_Sym || la.kind == or_Sym) {
			Or();
			Expression();
		} else if (la.kind == bang_Sym || la.kind == not_Sym) {
			Not();
			Expression();
...
public class Errors {
	...
	public static void SynErr (int line, int col, int n) {
		...
		switch (n) {
			...
			case 11: s = "invalid Operator"; break;
			case 12: s = "invalid Or"; break;
			case 13: s = "invalid Not"; break;
			case 14: s = "invalid And"; break;
