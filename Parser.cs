...
public class Parser {
	...
	public const int bang_Sym = 10;
	public const int abs_Sym = 11;
	...
	static void Parent() {
		...
		} else if (la.kind == decNumber_Sym || la.kind == hexNumber_Sym || la.kind == minus_Sym) {
			Factor();
			while (la.kind == bang_Sym) {
				Get();
			}
...
public class Errors {
	...
	public static void SynErr (int line, int col, int n) {
		...
		switch (n) {
			...
			case 13: s = "invalid Parent"; break;
