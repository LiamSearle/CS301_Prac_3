...
public class Parser {
	...
	public const int while_Sym = 20;
	public const int return_Sym = 21;
	public const int halt_Sym = 22;
	public const int read_Sym = 23;
	public const int write_Sym = 24;
	public const int plus_Sym = 25;
	public const int minus_Sym = 26;
	public const int new_Sym = 27;
	public const int bang_Sym = 28;
	public const int lbrackrbrack_Sym = 29;
	public const int int_Sym = 30;
	public const int bool_Sym = 31;
	public const int barbar_Sym = 32;
	public const int star_Sym = 33;
	public const int slash_Sym = 34;
	public const int andand_Sym = 35;
	public const int percent_Sym = 36;
	public const int equalequal_Sym = 37;
	public const int bangequal_Sym = 38;
	public const int less_Sym = 39;
	public const int lessequal_Sym = 40;
	public const int greater_Sym = 41;
	public const int greaterequal_Sym = 42;
	public const int NOT_SYM = 43;
	// pragmas
	...
	static bool[,] set = {
		...
		{x,T,x,x, x,x,x,x, T,x,T,T, x,x,x,x, x,x,x,T, T,T,T,T, T,x,x,x, x,x,T,T, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,T,T,T, T,T,T,x, x},
		{x,T,T,x, T,x,T,x, x,x,x,x, x,x,T,T, T,x,x,x, x,x,x,x, x,T,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,T,T,T, T,x,x,x, x,x,x,x, x},
		{x,x,T,x, T,x,x,x, x,x,x,x, x,x,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x}
...
public class Errors {
	...
	public static void SynErr (int line, int col, int n) {
		...
		switch (n) {
			...
			case 46: s = "invalid ReadElement"; break;
			case 47: s = "invalid WriteElement"; break;
